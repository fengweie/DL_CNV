...
parser.add_argument("--dataset", type=str, default="rose_wo", choices=["rose_wo"], help="dataset")  # choices可扩展
parser.add_argument("--mode", type=str, default="train", choices=["train", "test"], help="train or test")
# data settings
parser.add_argument("--data_dir", type=str,
        default="../data/ROSE_all",
                    help="path to folder for getting dataset")
parser.add_argument("--val_data_dir", type=str,
default=u"../data/test_seg/*",
                    help="path to folder for test dataset")
...
# training
parser.add_argument("--batch_size", type=int, default=8, choices=[3, 4], help="batch size")
...
# results
parser.add_argument("--backbone", type=str, default="unet", help="backbone model")
